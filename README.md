...
A "CMake install" version of MINKNAP.C, David Pisinger.

This repo contains a copy of the [minknap solver](http://hjemmesider.diku.dk/~pisinger/minknap.c) of David Pisinger.

You may cite this as
```
Pisinger, D. (1997). A Minimal Algorithm for the 0-1 Knapsack Problem. Operations Research, 45(5), 758–767. http://www.jstor.org/stable/172128
```

**I am not the author of this code.**

This repo is only intended to make the installation of `minknap` easy by using CMake.
...
Then, other projects can link with `minknap` as follows:
...
target_link(your_target PRIVATE minknap)
```
